...
//   wifiMulti.addAP("Orion Network", "0r10nP@ss");   // add Wi-Fi networks you want to connect to
...
//   MDNS.addService("controller", "tcp", 65432);
//   MDNS.addServiceTxt("controller", "tcp", "version", "test");
// }
